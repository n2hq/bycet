...
const MainNav = () => {
    ...
    return (
        <div>
            <MainNavProvider>
                <div className={`w-full h-[60px] border-b border-b-gray-100 fixed left-0 top-0 right-0 z-50 bg-white ${isOverThreshold && ' shadow-lg'}`}>
                    <div className={`max-w-[98%] h-full mx-auto w-full flex place-items-center place-content-between gap-5 relative`}>
                        {/** hamburger */}
                        <HamburgerMenu />
