export const InfoPrivacy = () => {
    return (
        <div className={`markdown prose dark:prose-invert w-full wrap-break-word light space-y-4`}>

            <h2 data-start="193" data-end="214" className={`text-xl`}>
                <div data-start="196" data-end="214"
            ...
            <h3 data-start="1220" data-end="1264">
                <strong data-start="1224" data-end="1264" id="cookies" className="scroll-mt-24">3. Cookies and Tracking Technologies</strong>
            </h3>
            ...
            <p data-start="3296" data-end="3371">
                <strong data-start="3299" data-end="3309">Email:</strong> <a href="mailto:help@veycet.com">info@bycet.com</a><br data-start="3331" data-end="3334" />
                🌐 <strong data-start="3337" data-end="3349">Website:</strong> <a href="/contact">bycet.com/contact</a>
            </p>
