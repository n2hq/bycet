...
const SigninButton = () => {
  return /* @__PURE__ */ jsx("div", { className: `hidden sm:block `, children: /* @__PURE__ */ jsx(Link, { className: ``, to: `https://index.bycet.com/web/signin`, children: /* @__PURE__ */ jsx("button", { className: ` w-[70px] h-[35px] border rounded-full text-sm border-gray-300 cursor-pointer hover:border-gray-800 hover:shadow-4xl`, children: "Sign in" }) }) });
};
const moremenu = [
  {
    title: "Home",
